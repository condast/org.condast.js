...
public class StringStyler 
{
	...
	/**
	 * condense the given string by removing the spaces and 
	...
	/**
	 * return a a string with first character lowercase.
	 * @param input
	 * @return
	 */
	public static String styleToFirstLowerCasel( String input ){
		String str = styleToEnum(input);
	...
	*/
	 ...
	 * @return
	 */
	public static String toNaturalText( String strng ){
		strng = strng.replaceAll("_8", ".");
